...
| Sélecteur de taille (chips) | Création de grille, Édition de grille | Chips 3×3 à 5×5 (FR-1). **2026-08-07** : changement de taille possible à tout moment, y compris après lancement d'une partie (FR-5) — plus de restriction, parité avec le champ de phrase (FR-3). |
